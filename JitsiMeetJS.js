...
export default {
    ...
    createLocalTracks(options = {}, firePermissionPromptIsShownEvent) {
        ...
        const obtainMediaPromise = RTCBrowserType.usesNewGumFlow()
            ? RTC._newObtainAudioAndVideoPermissions(options)
            : RTC.obtainAudioAndVideoPermissions(options);

        return obtainMediaPromise
            .then(tracks => {
